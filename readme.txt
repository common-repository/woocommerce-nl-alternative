...
> This plugin is unmaintained. The default Dutch translation for WooCommerce is or will be informal, which makes this plugin obsolete.


* Supports <a href="http://wordpress.org/extend/plugins/woocommerce/">WooCommerce</a> Version 2.4.12.
* Supports <a href="https://wordpress.org/themes/storefront/">Storefront</a> Version 1.5.3.
...
= 2.4.13 =
* 2015-
* Load our own language files too.
...
= 2.4.11 =
* 2015-12-08
* Woo 2.4.11 (no real update).

= 2.4.10 =
* 2015-11-11
* Woo 2.4.10 (no real update).
...
* Partial update for WooCommerce 2.4.4 (frontend).
...
= 1.1.7 =
* 2015-05-27
* Fork from WooCommerce (nl).
* Change strings from "u" to "je".
* Update to WooCommerce 2.3.8.

= 1.1.6 =
*	Fix use of undefined WPLANG constant in WordPress 4.0 and above.
